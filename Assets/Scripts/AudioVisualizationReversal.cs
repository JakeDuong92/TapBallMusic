...
public class AudioVisualizationReversal : MonoBehaviour
{
	...
	private void FixedUpdate()
	{
		...
		for (int i = 0; i < this.samples.Length; i++)
		{
			...
			if (child.localScale.y + child2.localScale.y + child3.localScale.y < this.cubePos.y)
			{
				...
				{
					child2.localScale = new Vector3(this.cubePos.x, this.cubePos.y, this.cubePos.z);
				...
				else
				{
					...
					child3.localScale = new Vector3(this.cubePos.x, this.cubePos.y / 3f, this.cubePos.z);
				}
			}
