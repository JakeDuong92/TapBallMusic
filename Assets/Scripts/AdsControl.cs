...
public class AdsControl : AdsManager
{
    ...
    public static AdsControl _instance;
    InterstitialAd interstitial;
    //RewardBasedVideoAd rewardBasedVideo;
    BannerView bannerView;
    ShowOptions options;
    public string AdmobID_Android, AdmobID_IOS, BannerID_Android, BannerID_IOS, interID_Android, interID_IOS;
    ...
    void Start()
    {
        RequestInterstitials(interID_Android, interID_IOS);
    }
    public void RequestInterstitial() => RequestInterstitials(interID_Android, interID_IOS);  
    ...
    public bool GetBannerAvailable()
    {
        bool avaiable = false;
        if (bannerView != null)
            avaiable = true;
